...
<h1 class="text-center mt-2"><a href="{{ route('product.view') }}" class=""><img src="{{url('/images/backarrow.png')}}" alt="Logo Image" width="100px" height="100px"/></a>Search Results</h1>
<hr>
<br>
